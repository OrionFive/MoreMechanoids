...
{
    // Sappers aren't a thing anymore. Breaching? Gotta test it first.
    ///// <summary>
    ...
    //{
    //    [HarmonyPatch(typeof(RaidStrategyWorker_ImmediateAttackSappers), nameof(RaidStrategyWorker.CanUseWith))]
